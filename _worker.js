...
let mytoken = 'auto';
let guestToken = 'wbking040408'; //可以随便取，或者uuid生成，https://1024tools.com/uuid
...
let urls = [];
let subConverter = "jiedian.w04040800.workers.dev"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
